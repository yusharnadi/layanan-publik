          ...
          <table class="table table-hover table-bordered">
            ...
            @foreach ($indicators as $indicator)  
                <tr>
                    ...
                    <td>
                      @if ($evaluasi = isEvaluated($indicator->indicator_id, $department->department_id, $tahun, $semester))   
                        <a href="{{route('rencana.create', $evaluasi->evaluasi_id)}}" class="btn btn-icon btn-sm btn-primary"><i class="fas fa-arrow-right"></i></a>    
                      @endif
                    </td>
                </tr>
            @endforeach
