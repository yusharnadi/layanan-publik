    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body table-responsive">
          <form method="get" action="{{route('rencana.index')}}">
            <div class="row mt-4">
          ...
          <table class="table table-hover datatable">
            ...
            @foreach ($departments as $department)  
                <tr>
                    ...
                    <td>
                        <a href="{{route('rencana.department', [$department->department_id, $tahun, $semester])}}" class="btn btn-icon btn-sm btn-info"><i class="fas fa-arrow-right"></i></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
