    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body table-responsive">
          <a href="{{route('aspects.create')}}" class="btn btn-info mb-2">Tambah Data</a>
          @if (session('error'))
          ...
          <table class="table table-hover datatable">
            ...
            @foreach ($aspects as $aspect)  
                <tr>
                    ...
                    <td>{{$aspect->aspect_bobot}}</td>
                    <td>
                        <a href="{{route('aspects.edit', $aspect->aspect_id)}}" class="btn btn-icon btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                        <a href="{{route('aspects.delete', $aspect->aspect_id)}}" class="btn btn-icon btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
