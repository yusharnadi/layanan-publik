...
<head>
  ...
  <title>Daftar Akun &mdash; {{ config('app.name')}}</title>
          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                @endif
                <form method="POST" action="{{route('doRegister')}}" class="needs-validation" novalidate="">
                  @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" type="email" class="form-control" name="email" value="{{old('email')}}" tabindex="2" required autofocus>
                    <div class="invalid-feedback">
