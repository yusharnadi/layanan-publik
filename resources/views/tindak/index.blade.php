...
@section('page-heading')
  ...
  <div class="section-header-breadcrumb">
    <div class="breadcrumb-item"><a href="{{route('rencana.index')}}">Tindak Lanjut</a></div>
          ...
          <table class="table table-hover table-bordered">
            ...
            @foreach ($indicators as $indicator)  
                <tr>
                    ...
                    <td>{!! isRencana($indicator->indicator_id, $department->department_id, $tahun, $semester) ? '<span class="badge badge-success">Sudah ada</span>' : '<span class="badge badge-secondary">Belum ada</span>'!!}</td>
                    <td>
                      @if ($rencana = isRencana($indicator->indicator_id, $department->department_id, $tahun, $semester))   
                        <a href="{{route('tindak.create', $rencana->rencana_id)}}" class="btn btn-icon btn-sm btn-primary"><i class="fas fa-arrow-right"></i></a>    
                      @endif
                    </td>
                </tr>
            @endforeach
