          ...
          <table class="table table-hover table-bordered">
            ...
            @foreach ($indicators as $indicator)  
                <tr>
                    ...
                    <td>{!! isTindak($indicator->indicator_id, $department->department_id, $tahun, $semester) ? '<span class="badge badge-success">Sudah ada</span>' : '<span class="badge badge-secondary">Belum ada</span>'!!}</td>
                    <td>
                      @if ($tindak = isTindak($indicator->indicator_id, $department->department_id, $tahun, $semester))   
                        <a href="{{route('tindak.detail-admin', $tindak->tindak_id)}}" class="btn btn-icon btn-sm btn-primary"><i class="fas fa-arrow-right"></i></a>    
                      @endif
                    </td>
                </tr>
            @endforeach
