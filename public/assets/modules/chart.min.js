                            ...
                            (t.controllers.bar = t.DatasetController.extend({
                                ...
                                draw: function () {
                                    var t = this,
                                        ...
                                        l = 0;
                                    for (
                                        o.canvas.clipArea(e.ctx, e.chartArea);
                                        l < r;
                                        ++l
                                    )
                                        isNaN(n.getRightValue(a.data[l])) ||
                                            i[l].draw();
                            ...
                            t.controllers.line = t.DatasetController.extend({
                                ...
                                removeHoverStyle: function (t) {
                                    ...
                                    void 0 !== n.radius &&
                                        ...
                                        (r.backgroundColor = e.getPointBackgroundColor(
                                            t,
                                            i
                                        )),
                        ...
                        legend: {
                            ...
                            onClick: function (t, e) {
                                ...
                                for (
                                    ...
                                    (a = r.getDatasetMeta(n)).data[
                                        o
                                    ].hidden = !a.data[o].hidden;
                                r.update();
                            },
                        },
                        tooltips: {
                            ...
                            t.controllers.radar = t.DatasetController.extend({
                                ...
                                updateBezierControlPoints: function () {
                                    ...
                                    o.each(e.data, function (n, i) {
                                        var a = n._model,
                                            r = o.splineCurve(
                                                o.previousItem(e.data, i, !0)
                                                    ._model,
                                                a,
                                                o.nextItem(e.data, i, !0)
                                                    ._model,
                                                a.tension
                                            );
                            ...
                            (t.Animation = a.extend({
                                ...
                                (t.animationService = {
                                    ...
                                    requestAnimationFrame: function () {
                                        var t = this;
                                        null === t.request &&
                                            (t.request = o.requestAnimFrame.call(
                                                window,
                                                function () {
                                                    (t.request = null),
                                                        t.startDigest();
                        ...
                        (t.types = {}),
                            ...
                            a.extend(t.prototype, {
                                    ...
                                    n.scales &&
                                        ...
                                        a.each(o, function (n) {
                                            var o = n.options,
                                                ...
                                                s = t.scaleService.getScaleConstructor(
                                                    r
                                                );
                                            if (s) {
                                                l(o.position) !==
                                ...
                                updateDatasets: function () {
                                    ...
                                    if (
                                        !1 !==
                                        s.notify(t, "beforeDatasetsUpdate")
                                    ) {
                                        for (
                                            var e = 0,
                                ...
                                updateDataset: function (t) {
                                    var e = this,
                                        ...
                                        i = { meta: n, index: t };
                                    !1 !==
                                        s.notify(e, "beforeDatasetUpdate", [
                                            i,
                                        ]) &&
                                        (n.controller.update(),
                                ...
                                drawDatasets: function (t) {
                                    ...
                                    if (
                                        !1 !==
                                        s.notify(e, "beforeDatasetsDraw", [t])
                                    ) {
                                        for (
                                            var n =
                                ...
                                drawDataset: function (t, e) {
                                    ...
                                    !1 !==
                                        s.notify(n, "beforeDatasetDraw", [a]) &&
                                        (i.controller.draw(e),
                                        s.notify(n, "afterDatasetDraw", [a]));
                                },
                                _drawTooltip: function (t) {
                                    ...
                                    !1 !==
                                        s.notify(e, "beforeTooltipDraw", [i]) &&
                                        (n.draw(),
                                        s.notify(e, "afterTooltipDraw", [i]));
                                },
            ...
            26: [
                function (t, e, n) {
                    ...
                    o.extend(r.prototype, {
                        ...
                        hasValue: function () {
                            return (
                                o.isNumber(this._model.x) &&
                                o.isNumber(this._model.y)
                            );
                        },
                    }),
                        (r.extend = o.inherits),
                        ...
                        (e.exports = function (t) {
                            ...
                            t.Scale = r.extend({
                                ...
                                beforeUpdate: function () {
                                    l.callback(this.options.beforeUpdate, [
                                        this,
                                    ]);
                                },
                                ...
                                afterUpdate: function () {
                                    l.callback(this.options.afterUpdate, [
                                        this,
                                    ]);
                                },
                                ...
                                beforeDataLimits: function () {
                                    l.callback(this.options.beforeDataLimits, [
                                        this,
                                    ]);
                                },
                                determineDataLimits: l.noop,
                                afterDataLimits: function () {
                                    l.callback(this.options.afterDataLimits, [
                                        this,
                                    ]);
                                },
                                beforeBuildTicks: function () {
                                    l.callback(this.options.beforeBuildTicks, [
                                        this,
                                    ]);
                                },
                                buildTicks: l.noop,
                                afterBuildTicks: function () {
                                    l.callback(this.options.afterBuildTicks, [
                                        this,
                                    ]);
                                },
                                ...
                                draw: function (t) {
                                    ...
                                    if (i.display) {
                                            ...
                                            (l.each(v, function (n, o) {
                                                if (!l.isNullOrUndef(n.label)) {
                                                    ...
                                                    i.offset ===
                                                        ...
                                                        : ((r = l.valueAtIndexOrDefault(
                                                              h.lineWidth,
                                                              o
                                                          )),
                                                          (s = l.valueAtIndexOrDefault(
                                                              h.color,
                                                              o
                                                          )),
                                                          (c = l.valueOrDefault(
                                        ...
                                        if (h.drawBorder) {
                                            (r.lineWidth = l.valueAtIndexOrDefault(
                                                h.lineWidth,
                                                0
                                            )),
                                                (r.strokeStyle = l.valueAtIndexOrDefault(
                                                    h.color,
                                                    0
                                                ));
                                            var z = e.left,
                ...
                function (t, e, n) {
                    ...
                    var i = {
                        ...
                        merge: function (t, e, n) {
                            ...
                            for (
                                a = (n = n || {}).merger || i._merger, o = 0;
                                o < d;
                                ++o
                            )
                                if (((e = u[o]), i.isObject(e)))
                                    for (
                                        s = 0, l = (r = Object.keys(e)).length;
                                        s < l;
                                        ++s
                                    )
                                        a(r[s], t, e, n);
                            ...
                            n = t.Scale.extend({
                                ...
                                buildTicks: function () {
                                    var t = this,
                                        ...
                                        o = (t.ticks = a.generators.logarithmic(
                                            n,
                                            t
                                        ));
                ...
                function (t, e, n) {
                    ...
                    function h(t, e, n, i) {
                        ...
                        for (a = M.length - 1; a >= M.indexOf(e); a--)
                            if (
                                ((o = M[a]), w[o].common && r.as(o) >= t.length)
                            )
                                return o;
                        ...
                        var e = t.Scale.extend({
                            ...
                            getLabelForIndex: function (t, e) {
                                ...
                                return (
                                    ...
                                    a.tooltipFormat &&
                                        (o = s(o, a).format(a.tooltipFormat)),
                                    o
                                );
                            },
